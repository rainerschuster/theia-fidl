package com.rainerschuster.xtext.langserver.fidl.scoping
...
class FIDLImportedNamespaceAwareLocalScopeProvider extends ImportedNamespaceAwareLocalScopeProvider {
